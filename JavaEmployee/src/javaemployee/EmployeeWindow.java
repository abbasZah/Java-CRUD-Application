...
public class EmployeeWindow extends javax.swing.JFrame {
    ...
    public static ArrayList<Employee> employeesList = DbClass.getEmployees();
    ...
    private void initComponents() {
        ...
        BTN_Remove.setBackground(new java.awt.Color(0, 102, 255));
    ...
    private void BTN_EditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BTN_EditActionPerformed
         try {
            ...
            new EditEmployeeWindow(id).setVisible(true);
            this.dispose();
        } catch (Exception e) {
    ...
    private void showTable(){
        ...
        Object[][] data = new Object[employeesList.size()][5];
        ...
        {    
                    ...
                    data[i][3]=c.getPhone_no();
                    data[i][4]=c.getDesignation();
        ...
        // Column Names 
        String[] columnNames = { "ID", "Name", "Gender", "Phone No", "Designation" }; 
